...
fun TaskListOwnerScreen(
    ...
    LaunchedEffect(Unit) {
        taskListViewModel.loadTasksForOwner(forceRefresh = false)
    }
    ...
    Scaffold(
        topBar = {
            BaseTopAppBar(
                ...
                onReload = { taskListViewModel.loadTasksForOwner(forceRefresh = true) },
